...
export default function Hero() {
    ...
    // Clean Code: Use custom hook for logic abstraction
    const { displayedText, isComplete: isTypingComplete } = useTypewriter({
        text: 'Meireles',
        speed: 150,
        delay: isMobile ? 0 : 500 // Optional delay for better UX
    });
